...
class User(Base):
    ...
    is_admin = Column(Boolean, default=False) # 0: normál felhasználó, 1: adminisztrátor
...
class Booking(Base):
    ...
    is_piad = Column(Boolean, default=False) # 0: foglalás, 1: fizetés megtörtént
    ...
    payment_method = Column(String, default="card") # "card" vagy "cash"
