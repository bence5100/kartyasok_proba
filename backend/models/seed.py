...
def upload_and_update():
   ...
   try:
        ...
        movie10 = Movie(title="A Gyűrűk Ura: A Gyűrű Szövetsége", description="Egy fiatal hobbit, Frodo, egy hatalmas erővel bíró gyűrűt örököl, amelyet el kell pusztítania, hogy megakadályozza a gonosz Sauron hatalomra jutását. Egy csapat hős társával együtt indul útnak, hogy megsemmisítse a gyűrűt és megmentse Középföldét.", duration_minutes=178, age_limit=12, genre="Fantasy", poster_url="https://image.tmdb.org/t/p/original/f2yO1mAJlXvP5tLcDGV8Y2Qr3Fx.jpg", trailer_url="https://www.youtube.com/watch?v=V75dMMIW2B4")
        movie11 = Movie(title="A Gyűrűk Ura: A Két Torony", description="Frodo és Sam tovább folytatják útjukat, hogy eljussanak Mordorba és megsemmisítsék a gyűrűt, miközben Aragorn, Legolas és Gimli harcolnak a gonosz erőkkel, amelyek fenyegetik Középföldét.", duration_minutes=179, age_limit=12, genre="Fantasy", poster_url="https://image.tmdb.org/t/p/original/bEyhrvkte5yVpw0fzRZq9kPE3t6.jpg", trailer_url="https://www.youtube.com/watch?v=LbfMDwc4azU")
        movie12 = Movie(title="A Gyűrűk Ura: A Király Visszatér", description="Frodo és Sam végre elérik Mordortot, hogy megsemmisítsék a gyűrűt, miközben Aragorn vezeti a sereget a végső csatába Sauron erői ellen, hogy megmentse Középföldét.", duration_minutes=201, age_limit=12, genre="Fantasy", poster_url="https://image.tmdb.org/t/p/original/5AjfQsNm7eJKAaYJZq23DMJvA5d.jpg", trailer_url="https://www.youtube.com/watch?v=r5X-hFf6Bwo")
